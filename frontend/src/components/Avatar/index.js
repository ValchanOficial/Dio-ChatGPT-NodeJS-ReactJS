import srcImg from './Valchan.png';
import './style.css';

const UserAvatar = () => {
    return (
        <img className="avatar-user" src={srcImg}alt="Valchan" />
    );
}

const ChatGPTAvatar = (props) => {
    return (
        <svg
            width={41}
            height={41}
...
const Avatar = (props) => props.from === 'user' ? <UserAvatar /> : <ChatGPTAvatar />;
